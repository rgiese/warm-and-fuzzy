                            ...
                            uint16_t const cbSource)
{
    ...
    size_t const cbDestinationRequired = (cbSource / 5) * 4;
    ...
    for (size_t idxSource = 0; idxSource < cbSource; ++idxSource)
    {
        // Accumulate value in base 85
        uint8_t sourceValueMinusBase = rgSource[idxSource] - sc_decoderRingBaseValue;
